    ...
    */
    ...
    void Update() {
        ...
        if (followTarget != null) {
            transform.position = Vector3.Lerp(cam.transform.position, new Vector3(followTarget.transform.position.x + offset.x, cam.transform.position.y + offset.y, followTarget.transform.position.z + offset.z), lerpSpeed);
        }
